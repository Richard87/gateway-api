...
helm install istiod istio/istiod -n istio-system --values values.yaml --version 1.28.1 --create-namespace  --wait
# helm upgrade istiod istio/istiod -n istio-system --version 1.28.1 --values values.yaml
